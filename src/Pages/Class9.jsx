...
export default function Class9() {
  ...
  return (
    <>
      <Helmet>
        <title>Class 9 Foundation Course in Patna | Team Excellent</title>
        <meta 
          name="description" 
          content="Start building strong basic concepts early with our school foundation course for Class 9 in Patna. Prepare for Science, Math, and Mental Ability." 
        />
        <link rel="canonical" href="https://teamexcellentcareerinstitute.in/class-9-in-patna" />
      </Helmet>
          ...
          <div className="bg-gradient-to-r from-[#2563eb] to-[#1d4ed8] text-white rounded-3xl p-8 md:p-12 mb-12 shadow-lg relative overflow-hidden">
            <div className="relative z-10 max-w-3xl">
              <span className="px-3.5 py-1 bg-white/10 border border-white/20 rounded-full text-xs font-bold uppercase tracking-wider text-blue-200 inline-block mb-4">
                Senior School Foundation Program
              </span>
              <h1 className="text-3xl md:text-5xl font-black mb-4 leading-tight">
                Class 9 Foundation Coaching
              </h1>
              <p className="text-blue-100 text-lg mb-8 leading-relaxed">
                Step up to higher difficulty. Our Class 9 foundation course bridges basic school lessons with introductory conceptual models of physics, chemistry, biology, and advanced algebra, preparing students for competitive boards.
              </p>
              <button 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm">
              ...
              <ul className="space-y-4">
                {[
                  "Detailed coverage of school board syllabus (CBSE/ICSE) with extended competitive levels.",
                  "Focus on logical reasoning and Mental Ability Tests (MAT).",
                  "Small class batches enabling direct teacher-student interaction.",
                  "Interactive learning sessions and periodic review reports for parents."
                ].map((item, idx) => (
              ...
              <div>
                ...
                <div className="space-y-3 text-sm text-gray-600 mb-6">
                  <p className="flex justify-between py-2 border-b border-gray-100">
                    ...
                    <span>1 Year / 2 Year Programs</span>
                  </p>
                  <p className="flex justify-between py-2 border-b border-gray-100">
                    <strong className="text-gray-700">Class Frequency:</strong>
                    <span>3 to 4 Days a Week</span>
                  </p>
                  <p className="flex justify-between py-2 border-b border-gray-100">
                    <strong className="text-gray-700">Subjects Covered:</strong>
                    <span>Mathematics, Physics, Chemistry, Biology, Mental Ability</span>
                  </p>
                </div>
              </div>
              <button 
