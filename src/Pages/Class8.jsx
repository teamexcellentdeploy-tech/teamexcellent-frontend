...
export default function Class8() {
  ...
  return (
    <>
      <Helmet>
        <title>Class 8 Foundation Course in Patna | Team Excellent</title>
        <meta 
          name="description" 
          content="Start building strong basic concepts early with our school foundation course for Class 8 in Patna. Prepare for Science, Math, and Mental Ability." 
        />
        <link rel="canonical" href="https://teamexcellentcareerinstitute.in/class-8-in-patna" />
      </Helmet>
          ...
          <div className="bg-gradient-to-r from-[#2563eb] to-[#1d4ed8] text-white rounded-3xl p-8 md:p-12 mb-12 shadow-lg relative overflow-hidden">
            <div className="relative z-10 max-w-3xl">
              ...
              <p className="text-blue-100 text-lg mb-8 leading-relaxed">
                Refine logical abilities. Our Class 8 foundation course bridges school lessons with introductory conceptual models of physics, chemistry, biology, and advanced algebra, preparing students for competitive boards.
              </p>
              <button 
