...
export default function Class7() {
  ...
  return (
    <>
      <Helmet>
        <title>Class 7 Foundation Course in Patna | Team Excellent</title>
        <meta 
          name="description" 
          content="Start building strong basic concepts early with our school foundation course for Class 7 in Patna. Prepare for Science, Math, and Mental Ability." 
        />
        <link rel="canonical" href="https://teamexcellentcareerinstitute.in/class-7-in-patna" />
      </Helmet>
          ...
          <div className="bg-gradient-to-r from-[#2563eb] to-[#1d4ed8] text-white rounded-3xl p-8 md:p-12 mb-12 shadow-lg relative overflow-hidden">
            <div className="relative z-10 max-w-3xl">
              ...
              <h1 className="text-3xl md:text-5xl font-black mb-4 leading-tight">
                Class 7 Foundation Coaching
              </h1>
              <p className="text-blue-100 text-lg mb-8 leading-relaxed">
                Empower analytical reasoning early. Our Class 7 foundation course delivers deeper understanding of scientific and algebraic formulas, preparing students step-by-step for NTSE and Olympiad level testing.
              </p>
              <button 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm">
              ...
              <ul className="space-y-4">
                {[
                  "In-depth focus on CBSE/ICSE school board syllabus with high-tier concepts.",
                  "Frequent mental ability reasoning worksheets (DPPs).",
                  "Expert mentors guiding students on formula derivations and step proofs.",
                  "Personalized academic performance reports shared monthly with parents."
                ].map((item, idx) => (
